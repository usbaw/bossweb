	...
	<div class="xop-section">
		<ul class="xop-grid">
			...
			<?php while($row = $result->fetch_assoc()) { ?>
					...
					<li>
						<div class="xop-box" style="background:linear-gradient(rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.10)),/* bottom, image */url(../boss-back/<?php echo $row['image']; ?>); background-position:center; background-size:cover; background-repeat:no-repeat;">
