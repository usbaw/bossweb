    ...
    $sql1 = "SELECT * FROM users WHERE email='$email'";
				...
				if(isset($_POST['verify'])){
					...
					if($security_answer == $txtanswer){
						echo '<script>window.location.href="forgot3.php"</script>';
					}else{
  ...
  <div class="login-box-body">
    ...
    <form  method="post">
      <div style="text-align:center;">
		  ...
		  <h4><?php echo  $security_question; ?> </h4>
		  <h4><input type="text" placeholder="Enter your answer" name="txtanswer" required></h4>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <input type="submit" name="verify" value="Verify" style="margin-left:120px; width:100;" class="btn btn-primary btn-block btn-flat" >
