...
<body class="hold-transition register-page" style="background-image: url(images/maxresdefault.jpg); background-position:center; background-size:cover;  ">
<div class="register-box" style="margin-top:20px;">
  <div class="register-box-body">
    <div class="register-logo">
    <a href="../index.php"><font color="black"><b>Bosss </b>Cars</font></a>
  </div>
    ...
    <form id="registerForm" action="index.html" method="post">
      ...
      <p class="login-box-msg">Security Question</p>
        ...
        <?php include 'security_question.txt'?>
        </select>
      </div>
      <div class="form-group has-feedback">
        <input type="text" id="cpassword" name="sec_ans" class="form-control" placeholder="You answer" required>
        <span class="glyphicon glyphicon-ok form-control-feedback"></span>
        <span id="sec_ans" class="color-red hide-me">Confirm Password Error</span>
      </div>
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" required> I agree to the <a href="../Welcome to Boss Cars UK.pdf" target="blank">terms</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <div align="center"> <a href="login.php" class="text-center">I already have an account</a> </div>
...
<script>
  $('#registerForm').on("submit", function(e) {
    ...
    if($("#sec_ans").val().length < 0) {
      $("#nameError").text("Answer for security question is required");
      $("#nameError").show();
      errors = true;
    } else {
      $("#nameError").hide();
