...
$_SESSION['callFrom'] = "view-blog.php?id=".$_GET['id'];
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <?php
                    echo '<img src="uploads/pages/'.$logo.'" class="profile-user-img img-responsive img-square" alt="User Image">';
                
                ?>

              <h3 class="profile-username text-center"><?php echo $name; ?></h3>

              <p class="text-muted text-center"><?php echo $subtitle; ?></p>
          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                ?>
  <?php
                    echo '<img src="uploads/pages/'.$logo.'" style="width:60%; padding:1px; display:block; margin-left:auto; margin-right:auto; background-color:white;  alt="User Image">';
			...
			<hr>
                  ...
                  <div class="box-header with-border">
                    <h3 class="box-title">Blog Discussion</h3>
                  </div>
                  <!-- /.box-header -->
                  <!-- form start -->
