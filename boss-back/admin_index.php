...
$name = $email = $city = $country = $aboutme = $profileimage = "";
...
if($result->num_rows > 0) { 
  while($row = $result->fetch_assoc()) {
    ...
    $password = base64_encode(strrev(md5($password1)));
  }
}
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <!--  <li class="active"><a href="#activity" data-toggle="tab">Activity</a></sli> -->
              <!-- <li><a href="#timeline" data-toggle="tab">Timeline</a></li> -->
              <!--<li><a href="#CARS" data-toggle="tab">My Car Details</a></li> -->
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="post" action="updateprofile.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail" placeholder="Email" value="<?php echo $email; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="myInput" placeholder="Email" value="<?php echo $password; ?>" required>
                   
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputCountry" class="col-sm-2 control-label">Security Question</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="question" id="question" placeholder="Security Question" value="<?php echo $security_question; ?>">
                  
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputCountry" class="col-sm-2 control-label">Answer</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="answer" id="inputCountry" placeholder="Security Answer" value="<?php echo $security_answer; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-danger"><li class="fa fa-update"></li>Update Account</button>
                    </div>
                  </div>
                  </form>
              </div>
                ...
                <form class="form-horizontal" method="post" action="updateprofile.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="name" id="inputName" placeholder="Car brand" value="<?php echo $name; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="name" id="inputName" placeholder="Car type" value="<?php echo $name; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="name" id="inputName" placeholder="Car color" value="<?php echo $name; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="name" id="inputName" placeholder="Plate Number" value="<?php echo $name; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputAboutMe" name="aboutme" placeholder="About your car"><?php echo $aboutme; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
