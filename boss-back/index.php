      ...
      <div class="row">
        <div class="col-md-8 col-sm-6 col-xs-12">
		 ...
		 $data2="";
               ...
               $id_usr=$_SESSION['id_user'];
				$data = mysqli_query($conn,"SELECT * FROM friends where id_user='$id_usr'");
				while($result=mysqli_fetch_array($data)){
				$qry=$qry. ' or p.id_user= '.$result['id_frienduser'];
				}
				//echo $qry;
                  $sql = "SELECT p.id_post,p.id_user,p.description,p.image,p.video,p.youtube,p.createdAt,u.name,u.profileimage FROM (post p inner join users u on p.id_user=u.id_user) where p.id_user= '$id_usr'".$qry." order by p.createdAt DESC";
              ...
              <ul class="users-list clearfix">
                ...
                <li>
                  <?php if($row['profileimage'] == '') {
                    ?>
                     <img src="dist/img/avatar5.png" alt="User Image" height="100px">
                    <?php
                  } else { ?>
                   <img src="uploads/profile/<?php echo $row['profileimage']; ?>" alt="User Image" height="100px">
                  <?php } ?>
        ...
        <?php } ?>
          ...
          <div class="box box-primary">
              ...
              <ul class="products-list product-list-in-box">
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="view-blog.php?id=<?php echo $row['id_page']; ?>" class="product-title"><?php echo $row['name']; ?>
            ...
            <!-- /.box-body -->
            <div class="box-footer text-center">
              <a href="user_view_blogs.php" class="uppercase">View All Blogs</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
