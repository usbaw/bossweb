...
<div class="wrapper">
  ...
  <section class="content-header">
      <h1>
        Friends <input type="text" oninput="searchfriend(this.value,'<?php echo $id_user;?>')" placeholder="find friends..."/>
      </h1>
...
<script>
var str="";
function searchfriend(str,str2) {
 var str2=document.getElementById("idno").value;
  ...
  xmlhttp.open("GET","searchfriend.php?name="+str+"&&uid="+str2,true);
  xmlhttp.send();
...
<input type="hidden" value="<?php echo $id_user;?>" id="idno">
