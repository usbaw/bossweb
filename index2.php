...
<body style="background-color:rgb(0,0,0);color:rgb(255,255,255);">
    ...
    <?php include 'nav.php';?>
        ...
        <div id="b-id">
            <h1 class="text-center" data-aos="fade-up" data-aos-duration="950" data-aos-once="true" id="title" style="color:rgb(255,255,255); margin-top:20px;">Boss Cars</h1>
        ...
        <div id="banner-bottom" style="width:100%;">
            <div class="container summary">
                ...
                <div class="row ban-bot1" data-aos="fade" data-aos-duration="700" data-aos-delay="700">
                    ...
                    <div class="col align-self-center" data-aos="fade-up" data-aos-duration="700" data-aos-delay="800"><a href="event.html"><button class="btn btn-primary btn-block join-button" type="button">Join Events</button></a></div>
                </div>
                <div class="row ban-bot1">
    ...
    <div
        ...
        <div class="container" id="e-id">
            <div class="intro">
                ...
                <p class="text-center" data-aos="fade-up" data-aos-duration="700" data-aos-delay="200" id="event-subtitle">Nunc luctus in metus eget fringilla. Aliquam sed justo ligula. Vestibulum nibh erat, pellentesque ut laoreet vitae. </p>
            </div>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item" data-aos="fade-up" data-aos-duration="700" data-aos-delay="250"><a href="BossEvent/index.php?id=top"><img class="img-fluid" src="assets/img/22.jpg"></a>
                    <h3 id="event4-title" class="name">Top Events</h3>
                    <p id="event-description1" class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="event.html" class="action"><i class="fa fa-arrow-circle-right"></i></a></div>
                <div
                    class="col-sm-6 col-md-4 item" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300"><a href="BossEvent/index.php?id=new"><img class="img-fluid" src="assets/img/21.jpg"></a>
                    <h3 id="event4-title" class="name">New Events</h3>
                    <p id="event-description2" class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="event.html" class="action"><i class="fa fa-arrow-circle-right"></i></a></div>
            <div
                class="col-sm-6 col-md-4 item" data-aos="fade-up" data-aos-duration="700" data-aos-delay="350"><a href="BossEvent/index.php?id=up"><img class="img-fluid" src="assets/img/52.jpg"></a>
                <h3 id="event4-title" class="name">Upcoming Events</h3>
                <p id="event-description3" class="description">Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus eu gravida. Aliquam varius finibus est, interdum justo suscipit id.</p><a href="event.html" class="action"><i class="fa fa-arrow-circle-right"></i></a></div>
        </div>
        </div>
        </div>
        <section id="business-logo" style="margin-top:30px;margin-bottom:30px;/*background-image:url(&quot;assets/img/maxresdefault.jpg&quot;);*/">
            <div class="intro">
                <h2 class="text-center" data-aos="fade-up" data-aos-duration="700" data-aos-delay="150" data-aos-once="true" id="logo-title">Business Logo</h2>
            ...
            <div class="row articles" id="b-logo-logo">
				...
				while($logo = mysqli_fetch_array($select)){
					$pic = $logo['picture'];
					echo '
					<div class="col-sm-6 col-md-4 item" data-aos="fade-up" data-aos-duration="700" data-aos-delay="250"><a href="#"><img class="img-fluid logo-style" src="boss-back/'.$pic.'" alt="Image Din Not Find"></a></div>
					';
				}
				?>
			</div>
